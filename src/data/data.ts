...
export const cities: CityData[] = [
  ...
  new CityData("Manila", "red", ["Hong Kong","Ho Chi Minh City","Sydney","San Francisco","Taipei"], { blue:0, red:0, yellow:0, black:0 }, 1768,740),
  ...
  new CityData("Tokyo", "red", ["Seoul","Shanghai","Osaka","San Francisco"], { blue:0, red:0, yellow:0, black:0 }, 1826,427),
  new CityData("Osaka", "red", ["Tokyo","Taipei"], { blue:0, red:0, yellow:0, black:0 }, 1040,420),
  new CityData("Sydney", "red", ["Los Angeles","Jakarta","Manila"], { blue:0, red:0, yellow:0, black:0 }, 1851,1024),
];
